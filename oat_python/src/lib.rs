...
use clique_filtered::FactoredBoundaryMatrixVrRelative;
use export::*;
use sprs::CsMat;
use sprs::CsMatBase;
...
/// import the module.
#[pymodule]
#[pyo3(name="oat_python")] // THIS WAS COMMENTED OUT BEFORE I REGISTERED VrRelative!
fn oat_python(_py: Python, m: &PyModule) -> PyResult<()> {
    ...
    m.add_class::<FactoredBoundaryMatrixVrRelative>()?;
